...
1. T1 hybrid: ray-query DDGI probes, ReSTIR direct lighting, hybrid reflections (the sky's
   term ✅, issue #49, D-031: Fresnel-weighted from the sky-view table; mirror rays for glass
   next), NRD. Ahead of the probes: the sky's irradiance ✅ (#47) and GTAO ✅ (#48, D-030).
